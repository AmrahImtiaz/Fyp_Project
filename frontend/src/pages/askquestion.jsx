          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                <Card className="shadow-lg border border-gray-200">
                  <CardHeader className="pb-2">
                    <CardTitle className="text-xl font-semibold unbounded">Question Details</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    ...
                    {/* Subject & Difficulty */}
                    <div className="grid md:grid-cols-2 gap-4 border-black">
              ...
              <Card className="shadow-lg border border-gray-200 bg-gray-50">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2 text-lg font-semibold text-gray-800 unbounded">
