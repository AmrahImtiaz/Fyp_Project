    ...
    <nav className="p-2 border-b border-gray-200 bg-transparent">
      <div className="max-w-7xl mx-auto flex justify-between items-center flex-wrap gap-3">
        ...
        <ul className="hidden lg:flex gap-7 items-center text-lg font-semibold">
          <li><Link to="/askquestion" className="hover:text-blue-600">Ask Questions</Link></li>
          <li><Link to="/browsequestions" className="hover:text-blue-600">Browse Questions</Link></li>
          <li><Link to="/Chatwithai" className="hover:text-blue-600">Chat with AI</Link></li>
      ...
      {mobileOpen && (
        <ul className="lg:hidden mt-3 space-y-4 text-lg font-semibold bg-white p-4 rounded-md shadow">
          <li><Link to="/askquestion">Ask Questions</Link></li>
          <li><Link to="/browsequestions">Browse Questions</Link></li>
          <li><Link to="/Chatwithai">Chat with AI</Link></li>
