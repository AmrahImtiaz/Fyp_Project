        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <ul className="hidden lg:flex items-center gap-6 text-sm font-medium text-gray-700">
              <li><Link to="/askquestion" className="hover:text-blue-600 transition hover:underline hover:underline-offset-6">Ask Questions</Link></li>
              <li><Link to="/browsequestions" className="hover:text-blue-600 transition hover:underline hover:underline-offset-6">Browse Questions</Link></li>
              <li><Link to="/Chatwithai" className="hover:text-blue-600 transition hover:underline hover:underline-offset-6">AI Chat</Link></li>
              <li><Link to="/about" className="hover:text-blue-600 transition hover:underline hover:underline-offset-6">About</Link></li>
            </ul>
      ...
      {mobileOpen && (
        <div className="lg:hidden border-t border-gray-100 bg-white px-4 py-4 space-y-4 shadow-lg">
          ...
          <div className="space-y-2">
            <Link to="/askquestion" className="block px-3 py-2 rounded-md hover:bg-gray-50 font-medium hover:underline hover:underline-offset-6 unbounded" onClick={() => setMobileOpen(false)}>Ask Questions</Link>
            <Link to="/browsequestions" className="block px-3 py-2 rounded-md hover:bg-gray-50 font-medium hover:underline hover:underline-offset-6 unbounded" onClick={() => setMobileOpen(false)}>Browse Questions</Link>
            <Link to="/Chatwithai" className="block px-3 py-2 rounded-md hover:bg-gray-50 font-medium hover:underline hover:underline-offset-6 unbounded" onClick={() => setMobileOpen(false)}>Chat with AI</Link>
            <Link to="/about" className="block px-3 py-2 rounded-md hover:bg-gray-50 font-medium hover:underline hover:underline-offset-6 unbounded" onClick={() => setMobileOpen(false)}>About</Link>
          </div>
